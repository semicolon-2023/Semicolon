...
async function fetchUserData() {
    await fetch('https://semicolon23.onrender.com/graphData')
...
async function updateMsg() {
    try {
        const response = await fetch('https://semicolon23.onrender.com/updateMsg', {
            method: 'POST',
            headers: {
...
async function updateName() {
    try {
        const response = await fetch('https://semicolon23.onrender.com/updateName', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function updatePhoto() {
    try {
        const response = await fetch('https://semicolon23.onrender.com/updatePhoto', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
